...
const BLOG = {
  ...
  AUTHOR: process.env.NEXT_PUBLIC_AUTHOR || 'Sturdylee', // 您的昵称 例如 tangly1024
  BIO: process.env.NEXT_PUBLIC_BIO || '白日梦想家', // 作者简介
  LINK: process.env.NEXT_PUBLIC_LINK || 'https://sturdylee.github.io', // 网站地址
